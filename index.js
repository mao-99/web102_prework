...
function addGamesToPage(games) {
    ...
    for (let i=0; i<games.length; i++){
        ...
        element.innerHTML = `<img src="${games[i].img}"  alt="${'alternative image'} class="${'game-img'}" width=100 height=100>
...
function filterUnfundedOnly() {
    ...
    console.log(unfundedGames, unfundedGames.length);
    // unfundedGames.length > 0 ? gamesContainer.appendChild(unfundedGames): gamesContainer.innerHTML = `<h2>There are no properly funded games</h2>`;
...
function filterFundedOnly() {
    ...
    console.log(fundedGames, fundedGames.length);
...
let displayStr = "";
unfundedGames > 1 ? displayStr = `A total of ${amountRaised} has been raised for ${fundedGames} games. Currently, ${unfundedGames} games remain unfunded. 
    We need your help to fund these amazing games!`: `A total of ${amountRaised} has been raised for ${fundedGames} games. Currently, 1 game remains unfunded. We need your help to fund this amazing game.`
